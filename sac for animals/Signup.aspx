<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="sac_for_animals.Signup" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                                <div class="col">
                                    <center>
                                        <img width="100px"<img src="imgs/usericon.png" />
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                   ...
                                   <div class="form-group">     
                                       <asp:TextBox CssClass="form-control" ID="contact_no" runat="server" placeholder="Phone Number" TextMode="Number"></asp:TextBox>
                                   </div>
                    ...
                    <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <lable>ID</lable>
                                   <div class="form-group">     
                                       <asp:TextBox Class="form-control" ID="member_id" runat="server" placeholder="User ID"></asp:TextBox>
                                   </div>
                                    <div class="col-md-6">
